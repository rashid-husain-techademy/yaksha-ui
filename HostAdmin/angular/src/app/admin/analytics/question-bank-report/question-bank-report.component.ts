...
@Component({
  selector: 'app-question-bank-report',
  templateUrl: './question-bank-report.component.html',
  styleUrls: ['./question-bank-report.component.scss']
})
export class QuestionBankReportComponent implements OnInit {
  userRole: string;
  ...
  getDashboard() {
    if (this.userRole !== UserRoles[1]) {
      ...
      let data: DashboardData = {
        dashboardType: DashboardType.OptionalType,
