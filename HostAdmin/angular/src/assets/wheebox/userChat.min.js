 ...
 */                
	...
	var choosechat=	Math.floor(Math.random() * 100);
	if(choosechat>0 && choosechat<20)
		document.getElementById("chatURL").innerHTML='wss://akschat.wheebox.com/';
	else if(choosechat>19 && choosechat<40)
		document.getElementById("chatURL").innerHTML='wss://akschat1.wheebox.com/';
	else if(choosechat>39 && choosechat<60)
		document.getElementById("chatURL").innerHTML='wss://akschat2.wheebox.com/';
	else if(choosechat>59 && choosechat<80)
		document.getElementById("chatURL").innerHTML='wss://akschat3.wheebox.com/';
	else if(choosechat>79 && choosechat<100)
		document.getElementById("chatURL").innerHTML='wss://akschat4.wheebox.com/';
    ...
    function connectionwsGet1(){
	    ...
	    if ('WebSocket' in window) { 
	    	...
	    	connectWS1(wssURL+''+instanceid+key_sno+'ws1/');
	    	console.log('key_sno: '+instanceid+key_sno);  
	    }else{  
	...
	var instanceid="";
	    ...
	    if ('WebSocket' in window) { 
	    	...
	    	connectWS2(wssURL+''+instanceid+key_sno+'ws1/');	   
